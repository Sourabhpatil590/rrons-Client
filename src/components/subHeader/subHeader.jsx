...
const SubHeader = () => {
    ...
    return (
        <Row md={12} className="sub-header">
            <Col md={7} className="left-col-sub-header">
                <Stack>
                    ...
                    <Row>
                        <Col className="" md="auto">
                            <img src="/acme.png" alt="client" height="45px" />
                        </Col>
                        <Col className="" md="auto">
                            <img src="/jenith.png" alt="client" height="45px" />
                        </Col>
                        <Col className="" md="auto">
                            <img src="/triz.png" alt="client" height="45px" />
                        </Col>
                        <Col className="" md="auto">
                            <img
                                src="/LDPharma.png"
            ...
            <Col md={5} className="right-col-sub-header">
